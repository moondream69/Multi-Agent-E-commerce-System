...
export class MarketGenerator {
  ...
  constructor(
    ...
    private readonly repo: Repository<MarketEmbedding>,
          ...
          [
            {
              role: 'system',
              content:
                '你是跨境电商市场分析专家。生成简洁、数据驱动的市场情报条目。',
            },
            {
              role: 'user',
              content: `生成 ${topic.count} 条"${topic.type}"类市场情报JSON数组，覆盖类目: ${topic.categories.join(', ')}。
