    ...
    parameters: [
      {
        name: 'action',
        type: 'string',
        description: '操作类型: create|listByCategory|findBySku|updateStatus',
        required: true,
      },
      {
        name: 'sku',
        type: 'string',
        description: '商品 SKU (create/findBySku 时使用)',
        required: false,
      },
      {
        name: 'title',
        type: 'string',
        description: '商品标题 (create 时使用)',
        required: false,
      },
      {
        name: 'price',
        type: 'number',
        description: '商品价格 (create 时使用)',
        required: false,
      },
      {
        name: 'category',
        type: 'string',
        description: '品类名称 (create/listByCategory 时使用)',
        required: false,
      },
      {
        name: 'description',
        type: 'string',
        description: '商品描述 (create 时使用)',
        required: false,
      },
      {
        name: 'id',
        type: 'string',
        description: '商品 ID (updateStatus 时使用)',
        required: false,
      },
      {
        name: 'status',
        type: 'string',
        description: '商品状态 (updateStatus 时使用)',
        required: false,
      },
    ],
  };
